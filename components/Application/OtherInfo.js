...
const OtherInfo = () => {
  return (
    <div>
      ...
      {/* Kennsla á skólatíma */}
      <div className={style.infoBox}> 
        <h3>Kennsla á skólatíma</h3>
        <a href="#">Hvað þýðir það?</a>
        <div className="Checkbox">
          <input className="Checkbox__input" type="checkbox" id="teachingonschooltime" />
      ...
      <div className={style.infoBox}> 
        <h3>Tónlistarnám</h3>
        <p>Ef við á, vinsamlegast skráið hér hvort umsækjandi hefur stundað nám við tónlistarskóla.</p>
        <div className="Attention">
          Engin krafa er gerð um fyrra tónlistarnám en gott er að fá upplýsingar um það til að raða rétt niður í hljómsveitirnar.
        </div>
      ...
      <div className={style.infoBox}> 
        <h3>Umsókn utan skólahverfis</h3>
