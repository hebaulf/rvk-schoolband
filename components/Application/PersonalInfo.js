          ...
          <fieldset className="form__infobox">
            <div className={`form__infobox ${style.flexbox1}`}>
              <div className="FormField FormField--readonly">
                <label className="FormField__label" for="name">
                  Nafn
                </label>
              ...
              <div className="FormField FormField--readonly">
                <label className="FormField__label" for="kt">
                  Kennitala
                </label>
                <span className="FormField__input" id="kt" readonly="">
                  030484-4556
                </span>
              </div>
            </div>
            <div className={`form__infobox ${style.flexbox2}`}>
              <div className="FormField FormField--readonly">
                <label className="FormField__label" for="address">
                  Heimilisfang
                </label>
              ...
              <div className="FormField FormField--readonly">
                <label className="FormField__label" for="postal">
                  Póstnúmer
                </label>
                <span
            ...
            <div className={`form__infobox ${style.flexbox3}`}>
              <div className="FormField TextInput">
                <label className="FormField__label" for="phone">
                  Sími
                </label>
                <input
              ...
              <div className="FormField TextInput">
                <label className="FormField__label" for="email">
                  Netfang
                </label>
                <input
                  className="FormField__input"
